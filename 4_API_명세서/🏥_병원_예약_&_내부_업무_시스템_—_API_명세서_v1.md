# 🏥 병원 예약 & 내부 업무 시스템 — API 명세서 v1 (1/3)
...
> **📄 문서 분권 안내**
본 문서는 전체 API 명세서를 3개로 분리한 문서입니다.
> 
> - **1/3 (현재):** 1. 공통 규칙 ~ 8. LLM 규칙 챗봇 API
> - **2/3:** 9. 관리자 예약·환자 API ~ 14. 관리자 대시보드 API
> - **3/3:** 15. 에러 코드 정의 + API 목록 요약
...
*⬅️ 이전 문서: API 명세서 (2/3) — 9. 관리자 예약·환자 API ~ 14. 관리자 대시보드 API*

*본 API 명세서는 프로젝트 계획서 v4.1, ERD v2.0, 시퀀스 다이어그램 v2.0을 기반으로 작성되었습니다.변경 발생 시 GitHub Wiki에서 버전 이력을 관리합니다.*